...
class Cliff (District):
	...
	def DefineSignals(self, tiles):
		...
		self.routes["CRtC20C44"] = Route(self.screen, block, "CRtC20C44", "C20", [ (144, 3), (145, 3), (146, 3), (147, 3), (148, 3), (149, 3), (150, 3), (151, 3), (152, 3), (153, 3), (154, 3)  ], "C44", [SLOW, SLOW], ["CSw43:N", "CSw49:N"], ["C6RF", "C6L"])
		self.routes["CRtC20C43"] = Route(self.screen, block, "CRtC20C43", "C20", [ (144, 5), (145, 5), (146, 5), (147, 5), (148, 5), (149, 4), (150, 3), (151, 3), (152, 3), (153, 3), (154, 3)  ], "C43", [SLOW, SLOW], ["CSw43:N", "CSw49:R"], ["C6RE", "C6L"])
		self.routes["CRtC20C42"] = Route(self.screen, block, "CRtC20C42", "C20", [ (144, 7), (145, 7), (146, 7), (147, 7), (148, 7), (149, 7), (150, 6), (151, 5), (152, 4), (153, 3), (154, 3)  ], "C42", [SLOW, SLOW], ["CSw43:R", "CSw45:R", "CSw51:N"], ["C6RD", "C6L"])
		self.routes["CRtC20C41"] = Route(self.screen, block, "CRtC20C41", "C20", [ (144, 9), (145, 8), (146, 7), (147, 7), (148, 7), (149, 7), (150, 6), (151, 5), (152, 4), (153, 3), (154, 3)  ], "C41", [SLOW, SLOW], ["CSw43:R", "CSw45:R", "CSw51:R"], ["C6RC", "C6L"])
		self.routes["CRtC20C40"] = Route(self.screen, block, "CRtC20C40", "C20", [ (139, 11), (140, 11), (141, 11), (142, 11), (143, 11), (144, 11), (145, 11), (146, 10), (147, 9), (148, 8), (149, 7), (150, 6), (151, 5), (152, 4), (153, 3), (154, 3)  ], "C40", [SLOW, SLOW], ["CSw43:R", "CSw45:N", "CSw47:R"], ["C6RB", "C6L"])
		self.routes["CRtC20C21"] = Route(self.screen, block, "CRtC20C21", "C20", [ (139, 13), (140, 13), (141, 13), (142, 13), (143, 13), (144, 12), (145, 11), (146, 10), (147, 9), (148, 8), (149, 7), (150, 6), (151, 5), (152, 4), (153, 3), (154, 3)  ], "C21", [MAIN, MAIN], ["CSw43:R", "CSw45:N", "CSw47:N", "CSw63:R"], ["C6RA", "C6L"])
		self.routes["CRtC20C50"] = Route(self.screen, block, "CRtC20C50", "C20", [ (139, 15), (140, 15), (141, 15), (142, 14), (143, 13), (144, 12), (145, 11), (146, 10), (147, 9), (148, 8), (149, 7), (150, 6), (151, 5), (152, 4), (153, 3), (154, 3)  ], "C50", [SLOW, SLOW], ["CSw43:R", "CSw45:N", "CSw47:N", "CSw63:N", "CSw65:R"], ["C6RG", "C6L"])
		self.routes["CRtC20C51"] = Route(self.screen, block, "CRtC20C51", "C20",
				[ (133, 17), (134, 17), (135, 17), (136, 17), (137, 17), (138, 17), (139, 17), (140, 16), (141, 15), (142, 14), (143, 13), (144, 12), (145, 11), (146, 10), (147, 9), (148, 8), (149, 7), (150, 6), (151, 5), (152, 4), (153, 3), (154, 3)  ], "C51", [SLOW, SLOW], ["CSw43:R", "CSw45:N", "CSw47:N", "CSw63:N", "CSw65:N", "CSw67:R", "CSw69:N"], ["C6RH", "C6L"])
		self.routes["CRtC20C52"] = Route(self.screen, block, "CRtC20C52", "C20",
				[ (133, 19), (134, 19), (135, 18), (136, 17), (137, 17), (138, 17), (139, 17), (140, 16), (141, 15), (142, 14), (143, 13), (144, 12), (145, 11), (146, 10), (147, 9), (148, 8), (149, 7), (150, 6), (151, 5), (152, 4), (153, 3), (154, 3)  ], "C52", [SLOW, SLOW], ["CSw43:R", "CSw45:N", "CSw47:N", "CSw63:N", "CSw65:N", "CSw67:R", "CSw69:R"], ["C6RJ", "C6L"])
		self.routes["CRtC20C53"] = Route(self.screen, block, "CRtC20C53", "C20",
				[ (133, 21), (134, 21), (135, 21), (136, 20), (137, 19), (138, 18), (139, 17), (140, 16), (141, 15), (142, 14), (143, 13), (144, 12), (145, 11), (146, 10), (147, 9), (148, 8), (149, 7), (150, 6), (151, 5), (152, 4), (153, 3), (154, 3)  ], "C53", [SLOW, SLOW], ["CSw43:R", "CSw45:N", "CSw47:N", "CSw63:N", "CSw65:N", "CSw67:N", "CSw71:R"], ["C6RK", "C6L"])
		self.routes["CRtC20C54"] = Route(self.screen, block, "CRtC20C54", "C20",
				[ (133, 23), (134, 22), (135, 21), (136, 20), (137, 19), (138, 18), (139, 17), (140, 16), (141, 15), (142, 14), (143, 13), (144, 12), (145, 11), (146, 10), (147, 9), (148, 8), (149, 7), (150, 6), (151, 5), (152, 4), (153, 3), (154, 3)  ], "C54", [SLOW, SLOW], ["CSw43:R", "CSw45:N", "CSw47:N", "CSw63:N", "CSw65:N", "CSw67:N", "CSw71:N"], ["C6RL", "C6L"])
		...
		self.routes["CRtC44C22"] = Route(self.screen, block, "CRtC44C22", "C44", [ (106, 13), (107, 13), (108, 12), (109, 11), (110, 10), (111, 9), (112, 8), (113, 7), (114, 6), (115, 5), (116, 4), (117, 3)  ], "C22", [SLOW, SLOW], ["CSw57:N", "CSw59:N", "CSw61:R"], ["C8R", "C8LF"])
		self.routes["CRtC43C22"] = Route(self.screen, block, "CRtC43C22", "C43", [ (106, 13), (107, 13), (108, 12), (109, 11), (110, 10), (111, 9), (112, 8), (113, 7), (114, 6), (115, 5), (116, 5), (117, 5)  ], "C22", [SLOW, SLOW], ["CSw57:R", "CSw59:N", "CSw61:R"], ["C8R", "C8LE"])
		self.routes["CRtC42C22"] = Route(self.screen, block, "CRtC42C22", "C42", [ (106, 13), (107, 13), (108, 12), (109, 11), (110, 10), (111, 9), (112, 9), (113, 9), (114, 9), (115, 8), (116, 7), (117, 7)  ], "C22", [SLOW, SLOW], ["CSw53:R", "CSw59:R", "CSw61:R"], ["C8R", "C8LD"])
		self.routes["CRtC41C22"] = Route(self.screen, block, "CRtC41C22", "C41", [ (106, 13), (107, 13), (108, 12), (109, 11), (110, 10), (111, 9), (112, 9), (113, 9), (114, 9), (115, 9), (116, 9), (117, 9)  ], "C22", [SLOW, SLOW], ["CSw53:N", "CSw59:R", "CSw61:R"], ["C8R", "C8LC"])
		self.routes["CRtC40C22"] = Route(self.screen, block, "CRtC40C22", "C40", [ (106, 13), (107, 13), (108, 13), (109, 13), (110, 13), (111, 12), (112, 11), (113, 11), (114, 11), (115, 11), (116, 11), (117, 11)  ], "C22", [SLOW, SLOW], ["CSw55:R", "CSw61:N"], ["C8R", "C8LB"])
		self.routes["CRtC21C22"] = Route(self.screen, block, "CRtC21C22", "C21", [ (106, 13), (107, 13), (108, 13), (109, 13), (110, 13), (111, 13), (112, 13), (113, 13), (114, 13), (115, 13), (116, 13), (117, 13)  ], "C22", [MAIN, DIVERGING], ["CSw55:N", "CSw61:N", "CSw73:N"], ["C8R", "C8LA"])
		self.routes["CRtC50C22"] = Route(self.screen, block, "CRtC50C22", "C50", [ (106, 13), (107, 13), (108, 13), (109, 13), (110, 13), (111, 13), (112, 13), (113, 13), (114, 14), (115, 15), (116, 15), (117, 15)  ], "C22", [SLOW, SLOW], ["CSw55:N", "CSw61:N", "CSw73:R", "CSw75:R"], ["C8R", "C8LG"])
		self.routes["CRtC51C22"] = Route(self.screen, block, "CRtC51C22", "C51", [
				(106, 13), (107, 13), (108, 13), (109, 13), (110, 13), (111, 13), (112, 13), (113, 13), (114, 14), (115, 15), (116, 16), (117, 17), (118, 17), (119, 17), (120, 17), (121, 17), (122, 17), (123, 17)  ], "C22", [SLOW, SLOW], ["CSw55:N", "CSw61:N", "CSw73:R", "CSw75:N", "CSw77:R", "CSw79:N"], ["C8R", "C8LH"])
		self.routes["CRtC52C22"] = Route(self.screen, block, "CRtC52C22", "C52", [
				(106, 13), (107, 13), (108, 13), (109, 13), (110, 13), (111, 13), (112, 13), (113, 13), (114, 14), (115, 15), (116, 16), (117, 17), (118, 17), (119, 17), (120, 17), (121, 18), (122, 19), (123, 19)  ], "C22", [SLOW, SLOW], ["CSw55:N", "CSw61:N", "CSw73:R", "CSw75:N", "CSw77:R", "CSw79:R"], ["C8R", "C8LJ"])
		self.routes["CRtC53C22"] = Route(self.screen, block, "CRtC53C22", "C53", [
				(106, 13), (107, 13), (108, 13), (109, 13), (110, 13), (111, 13), (112, 13), (113, 13), (114, 14), (115, 15), (116, 16), (117, 17), (118, 18), (119, 19), (120, 20), (121, 21), (122, 21), (123, 21)  ], "C22", [SLOW, SLOW], ["CSw55:N", "CSw61:N", "CSw73:R", "CSw75:N", "CSw77:N", "CSw81:R"], ["C8R", "C8LK"])
		self.routes["CRtC54C22"] = Route(self.screen, block, "CRtC54C22", "C54", [
				(106, 13), (107, 13), (108, 13), (109, 13), (110, 13), (111, 13), (112, 13), (113, 13), (114, 14), (115, 15), (116, 16), (117, 17), (118, 18), (119, 19), (120, 20), (121, 21), (122, 22), (123, 23)  ], "C22", [SLOW, SLOW], ["CSw55:N", "CSw61:N", "CSw73:R", "CSw75:N", "CSw77:N", "CSw81:N"], ["C8R", "C8LL"])
