...
class Cliff (District):
	...
	def DetermineRoute(self, blocks):
		for block in blocks:
			...
			if bname == "COSGMW":
				...
				s43 = 'N' if self.turnouts["CSw43"].IsNormal() else 'R'
				if s43 == "N":
					s49 = 'N' if self.turnouts["CSw49"].IsNormal() else 'R'
					if s49 == "N":
						block.SetRoute(self.routes["CRtC20C44"])
					else:  # s49 == R
						block.SetRoute(self.routes["CRtC20C43"])
				else:  # s43 == R
					s45 = 'N' if self.turnouts["CSw45"].IsNormal() else 'R'
					if s45 == "R":
						s51 = 'N' if self.turnouts["CSw51"].IsNormal() else 'R'
						if s51 == "N":
							block.SetRoute(self.routes["CRtC20C42"])
						else:
							block.SetRoute(self.routes["CRtC20C41"])
					else:  # s45 == N
						s47 = 'N' if self.turnouts["CSw47"].IsNormal() else 'R'
						if s47 == "R":
							block.SetRoute(self.routes["CRtC20C40"])
						else:  # s47 == N
							s63 = 'N' if self.turnouts["CSw63"].IsNormal() else 'R'
							if s63 == "R":
								block.SetRoute(self.routes["CRtC20C21"])
							else:  # s63 == N
								s65 = 'N' if self.turnouts["CSw65"].IsNormal() else 'R'
								if s65 == "R":
									block.SetRoute(self.routes["CRtC20C50"])
								else:  # s65 == N
									s67 = 'N' if self.turnouts["CSw67"].IsNormal() else 'R'
									if s67 == "R":
										s69 = 'N' if self.turnouts["CSw69"].IsNormal() else 'R'
										if s69 == "N":
											block.SetRoute(self.routes["CRtC20C51"])
										else:
											block.SetRoute(self.routes["CRtC20C52"])
									else:  # s67 == "N"
										s71 = 'N' if self.turnouts["CSw71"].IsNormal() else 'R'
										if s71 == "R":
											block.SetRoute(self.routes["CRtC20C53"])
										else:
											block.SetRoute(self.routes["CRtC20C54"])
			elif bname == "COSSHW":
				s61 = 'N' if self.turnouts["CSw61"].IsNormal() else 'R'
				if s61 == 'R':
					s59 = 'N' if self.turnouts["CSw59"].IsNormal() else 'R'
					if s59 == 'N':
						s57 = 'N' if self.turnouts["CSw57"].IsNormal() else 'R'
						if s57 == 'N':
							block.SetRoute(self.routes["CRtC44C22"])
						else:
							block.SetRoute(self.routes["CRtC43C22"])
					else:  # s59 == R
						s53 = 'N' if self.turnouts["CSw53"].IsNormal() else 'R'
						if s53 == 'R':
							block.SetRoute(self.routes["CRtC42C22"])
						else:
							block.SetRoute(self.routes["CRtC41C22"])
				else:  # s61 == N
					s55 = 'N' if self.turnouts["CSw55"].IsNormal() else 'R'
					if s55 == 'R':
						block.SetRoute(self.routes["CRtC40C22"])
					else:
						s73 = 'N' if self.turnouts["CSw73"].IsNormal() else 'R'
						if s73 == 'N':
							block.SetRoute(self.routes["CRtC21C22"])
						else:
							s75 = 'N' if self.turnouts["CSw75"].IsNormal() else 'R'
							if s75 == 'R':
								block.SetRoute(self.routes["CRtC50C22"])
							else:
								s77 = 'N' if self.turnouts["CSw77"].IsNormal() else 'R'
								if s77 == 'R':
									s79 = 'N' if self.turnouts["CSw79"].IsNormal() else 'R'
									if s79 == 'N':
										block.SetRoute(self.routes["CRtC51C22"])
									else:
										block.SetRoute(self.routes["CRtC52C22"])
								else:  # s77 == N
									s81 = 'N' if self.turnouts["CSw81"].IsNormal() else 'R'
									if s81 == 'R':
										block.SetRoute(self.routes["CRtC53C22"])
									else:
										block.SetRoute(self.routes["CRtC54C22"])
	...
	def DefineBlocks(self, tiles):
		...
		self.blocks["C44"] = Block(self, self.frame, "C44",
			[
				(tiles["horiznc"],        self.screen, (119, 3), False),
				(tiles["horiz"],          self.screen, (120, 3), False),
				(tiles["horiznc"],        self.screen, (121, 3), False),
				(tiles["horiz"],          self.screen, (122, 3), False),
				(tiles["horiznc"],        self.screen, (123, 3), False),
				(tiles["horiz"],          self.screen, (124, 3), False),
				(tiles["horiznc"],        self.screen, (125, 3), False),
				(tiles["horiz"],          self.screen, (126, 3), False),
				(tiles["horiznc"],        self.screen, (127, 3), False),
				(tiles["horiz"],          self.screen, (128, 3), False),
				(tiles["horiznc"],        self.screen, (129, 3), False),
				(tiles["horiz"],          self.screen, (130, 3), False),
				(tiles["horiznc"],        self.screen, (131, 3), False),
				(tiles["horiz"],          self.screen, (132, 3), False),
				(tiles["horiznc"],        self.screen, (133, 3), False),
				(tiles["horiz"],          self.screen, (134, 3), False),
				(tiles["horiznc"],        self.screen, (135, 3), False),
				(tiles["horiz"],          self.screen, (136, 3), False),
				(tiles["horiznc"],        self.screen, (137, 3), False),
				(tiles["horiz"],          self.screen, (138, 3), False),
				(tiles["horiznc"],        self.screen, (139, 3), False),
				(tiles["horiz"],          self.screen, (140, 3), False),
				(tiles["horiznc"],        self.screen, (141, 3), False),
				(tiles["horiz"],          self.screen, (142, 3), False),
			], False)
		self.blocks["C44"].AddTrainLoc(self.screen, (122, 3))

		self.blocks["C43"] = Block(self, self.frame, "C43",
			[
				(tiles["horiznc"],        self.screen, (119, 5), False),
				(tiles["horiz"],          self.screen, (120, 5), False),
				(tiles["horiznc"],        self.screen, (121, 5), False),
				(tiles["horiz"],          self.screen, (122, 5), False),
				(tiles["horiznc"],        self.screen, (123, 5), False),
				(tiles["horiz"],          self.screen, (124, 5), False),
				(tiles["horiznc"],        self.screen, (125, 5), False),
				(tiles["horiz"],          self.screen, (126, 5), False),
				(tiles["horiznc"],        self.screen, (127, 5), False),
				(tiles["horiz"],          self.screen, (128, 5), False),
				(tiles["horiznc"],        self.screen, (129, 5), False),
				(tiles["horiz"],          self.screen, (130, 5), False),
				(tiles["horiznc"],        self.screen, (131, 5), False),
				(tiles["horiz"],          self.screen, (132, 5), False),
				(tiles["horiznc"],        self.screen, (133, 5), False),
				(tiles["horiz"],          self.screen, (134, 5), False),
				(tiles["horiznc"],        self.screen, (135, 5), False),
				(tiles["horiz"],          self.screen, (136, 5), False),
				(tiles["horiznc"],        self.screen, (137, 5), False),
				(tiles["horiz"],          self.screen, (138, 5), False),
				(tiles["horiznc"],        self.screen, (139, 5), False),
				(tiles["horiz"],          self.screen, (140, 5), False),
				(tiles["horiznc"],        self.screen, (141, 5), False),
				(tiles["horiz"],          self.screen, (142, 5), False),
			], False)
		self.blocks["C43"].AddTrainLoc(self.screen, (122, 5))

		self.blocks["C42"] = Block(self, self.frame, "C42",
			[
				(tiles["horiznc"],        self.screen, (119, 7), False),
				(tiles["horiz"],          self.screen, (120, 7), False),
				(tiles["horiznc"],        self.screen, (121, 7), False),
				(tiles["horiz"],          self.screen, (122, 7), False),
				...
				(tiles["horiznc"],        self.screen, (133, 7), False),
				(tiles["horiz"],          self.screen, (134, 7), False),
				(tiles["horiznc"],        self.screen, (135, 7), False),
				(tiles["horiz"],          self.screen, (136, 7), False),
				(tiles["horiznc"],        self.screen, (137, 7), False),
				(tiles["horiz"],          self.screen, (138, 7), False),
				(tiles["horiznc"],        self.screen, (139, 7), False),
				(tiles["horiz"],          self.screen, (140, 7), False),
				(tiles["horiznc"],        self.screen, (141, 7), False),
				(tiles["horiz"],          self.screen, (142, 7), False),
			], False)
		self.blocks["C42"].AddTrainLoc(self.screen, (122, 7))

		self.blocks["C41"] = Block(self, self.frame, "C41",
			[
				(tiles["horiznc"],        self.screen, (119, 9), False),
				(tiles["horiz"],          self.screen, (120, 9), False),
				(tiles["horiznc"],        self.screen, (121, 9), False),
				(tiles["horiz"],          self.screen, (122, 9), False),
				(tiles["horiznc"],        self.screen, (123, 9), False),
				(tiles["horiz"],          self.screen, (124, 9), False),
				(tiles["horiznc"],        self.screen, (125, 9), False),
				(tiles["horiz"],          self.screen, (126, 9), False),
				(tiles["horiznc"],        self.screen, (127, 9), False),
				(tiles["horiz"],          self.screen, (128, 9), False),
				(tiles["horiznc"],        self.screen, (129, 9), False),
				(tiles["horiz"],          self.screen, (130, 9), False),
				(tiles["horiznc"],        self.screen, (131, 9), False),
				(tiles["horiz"],          self.screen, (132, 9), False),
				(tiles["horiznc"],        self.screen, (133, 9), False),
				(tiles["horiz"],          self.screen, (134, 9), False),
				(tiles["horiznc"],        self.screen, (135, 9), False),
				(tiles["horiz"],          self.screen, (136, 9), False),
				(tiles["horiznc"],        self.screen, (137, 9), False),
				(tiles["horiz"],          self.screen, (138, 9), False),
				(tiles["horiznc"],        self.screen, (139, 9), False),
				(tiles["horiz"],          self.screen, (140, 9), False),
				(tiles["horiznc"],        self.screen, (141, 9), False),
				(tiles["horiz"],          self.screen, (142, 9), False),
			], False)
		...
		self.blocks["C40"] = Block(self, self.frame, "C40",
			[
				...
				(tiles["horiznc"],        self.screen, (121, 11), False),
				(tiles["horiz"],          self.screen, (122, 11), False),
				...
				(tiles["horiz"],          self.screen, (128, 11), False),
				(tiles["horiznc"],        self.screen, (129, 11), False),
				(tiles["horiz"],          self.screen, (130, 11), False),
		...
		self.blocks["C21"] = Block(self, self.frame, "C21",
			[
				...
				(tiles["horiz"],          self.screen, (128, 13), False),
				(tiles["horiznc"],        self.screen, (129, 13), False),
				(tiles["horiz"],          self.screen, (130, 13), False),
				(tiles["horiznc"],        self.screen, (131, 13), False),
				(tiles["horiz"],          self.screen, (132, 13), False),
				(tiles["horiznc"],        self.screen, (133, 13), False),
				(tiles["horiz"],          self.screen, (134, 13), False),
				(tiles["horiznc"],        self.screen, (135, 13), False),
				(tiles["horiz"],          self.screen, (136, 13), False),
		...
		self.blocks["C50"] = Block(self, self.frame, "C50",
			[
				(tiles["horiznc"],        self.screen, (119, 15), False),
				(tiles["horiz"],          self.screen, (120, 15), False),
				(tiles["horiznc"],        self.screen, (121, 15), False),
				(tiles["horiz"],          self.screen, (122, 15), False),
				(tiles["horiznc"],        self.screen, (123, 15), False),
				(tiles["horiz"],          self.screen, (124, 15), False),
				(tiles["horiznc"],        self.screen, (125, 15), False),
				(tiles["horiz"],          self.screen, (126, 15), False),
				(tiles["horiznc"],        self.screen, (127, 15), False),
				(tiles["horiz"],          self.screen, (128, 15), False),
				(tiles["horiznc"],        self.screen, (129, 15), False),
				(tiles["horiz"],          self.screen, (130, 15), False),
				(tiles["horiznc"],        self.screen, (131, 15), False),
				(tiles["horiz"],          self.screen, (132, 15), False),
				(tiles["horiznc"],        self.screen, (133, 15), False),
				(tiles["horiz"],          self.screen, (134, 15), False),
				(tiles["horiznc"],        self.screen, (135, 15), False),
				(tiles["horiz"],          self.screen, (136, 15), False),
				(tiles["horiznc"],        self.screen, (137, 15), False),
			], False)
		...
		self.blocks["C53"] = Block(self, self.frame, "C53",
			[
				(tiles["horiznc"],        self.screen, (125, 21), False),
				(tiles["horiz"],          self.screen, (126, 21), False),
				(tiles["horiznc"],        self.screen, (127, 21), False),
				(tiles["horiz"],          self.screen, (128, 21), False),
				(tiles["horiznc"],        self.screen, (129, 21), False),
				(tiles["horiz"],          self.screen, (130, 21), False),
				(tiles["horiznc"],        self.screen, (131, 21), False),
			], False)
		self.blocks["C53"].AddTrainLoc(self.screen, (126, 21))

		self.blocks["C54"] = Block(self, self.frame, "C54",
			[
				(tiles["horiznc"],        self.screen, (125, 23), False),
				(tiles["horiz"],          self.screen, (126, 23), False),
				(tiles["horiznc"],        self.screen, (127, 23), False),
				(tiles["horiz"],          self.screen, (128, 23), False),
				(tiles["horiznc"],        self.screen, (129, 23), False),
				(tiles["horiz"],          self.screen, (130, 23), False),
				(tiles["horiznc"],        self.screen, (131, 23), False),
			], False)
		self.blocks["C54"].AddTrainLoc(self.screen, (126, 23))

		self.blocks["COSSHE"] = OverSwitch(self, self.frame, "COSSHE",
			[
				(tiles["horiznc"],        self.screen, (144, 3), False),
				(tiles["horiz"],          self.screen, (145, 3), False),
				(tiles["horiznc"],        self.screen, (146, 3), False),
				(tiles["horiz"],          self.screen, (147, 3), False),
				(tiles["horiznc"],        self.screen, (148, 3), False),
				(tiles["horiz"],          self.screen, (149, 3), False),
				(tiles["horiz"],          self.screen, (151, 3), False),
				(tiles["horiznc"],        self.screen, (152, 3), False),
				(tiles["eobright"],       self.screen, (154, 3), False),

				(tiles["horiznc"],        self.screen, (144, 5), False),
				(tiles["horiz"],          self.screen, (145, 5), False),
				(tiles["horiznc"],        self.screen, (146, 5), False),
				(tiles["horiz"],          self.screen, (147, 5), False),
				(tiles["turnleftright"],  self.screen, (148, 5), False),
				(tiles["diagleft"],       self.screen, (149, 4), False),

				(tiles["horiznc"],        self.screen, (144, 7), False),
				(tiles["horiz"],          self.screen, (145, 7), False),
				(tiles["horiz"],          self.screen, (147, 7), False),
				(tiles["horiznc"],        self.screen, (148, 7), False),
				(tiles["diagleft"],       self.screen, (150, 6), False),
				(tiles["diagleft"],       self.screen, (151, 5), False),
				(tiles["diagleft"],       self.screen, (152, 4), False),

				(tiles["turnleftright"],  self.screen, (144, 9), False),
				(tiles["diagleft"],       self.screen, (145, 8), False),

				(tiles["horiz"],          self.screen, (139, 11), False),
				(tiles["horiznc"],        self.screen, (140, 11), False),
				(tiles["horiz"],          self.screen, (141, 11), False),
				(tiles["horiznc"],        self.screen, (142, 11), False),
				(tiles["horiz"],          self.screen, (143, 11), False),
				(tiles["horiznc"],        self.screen, (144, 11), False),
				(tiles["diagleft"],       self.screen, (146, 10), False),
				(tiles["diagleft"],       self.screen, (147, 9), False),
				(tiles["diagleft"],       self.screen, (148, 8), False),

				(tiles["horiz"],          self.screen, (139, 13), False),
				(tiles["horiznc"],        self.screen, (140, 13), False),
				(tiles["horiz"],          self.screen, (141, 13), False),
				(tiles["horiznc"],        self.screen, (142, 13), False),
				(tiles["diagleft"],       self.screen, (144, 12), False),

				(tiles["horiz"],          self.screen, (139, 15), False),
				(tiles["horiznc"],        self.screen, (140, 15), False),
				(tiles["diagleft"],       self.screen, (142, 14), False),

				(tiles["horiz"],          self.screen, (133, 17), False),
				(tiles["horiznc"],        self.screen, (134, 17), False),
				(tiles["horiz"],          self.screen, (135, 17), False),
				(tiles["horiz"],          self.screen, (137, 17), False),
				(tiles["horiznc"],        self.screen, (138, 17), False),
				(tiles["diagleft"],       self.screen, (140, 16), False),

				(tiles["horiz"],          self.screen, (133, 19), False),
				(tiles["turnleftright"],  self.screen, (134, 19), False),
				(tiles["diagleft"],       self.screen, (135, 18), False),

				(tiles["horiz"],          self.screen, (133, 21), False),
				(tiles["horiznc"],        self.screen, (134, 21), False),
				(tiles["diagleft"],       self.screen, (136, 20), False),
				(tiles["diagleft"],       self.screen, (137, 19), False),
				(tiles["diagleft"],       self.screen, (138, 18), False),

				(tiles["turnleftright"],  self.screen, (133, 23), False),
		...
		self.blocks["COSSHW"] = OverSwitch(self, self.frame, "COSSHW",
			[
				...
				(tiles["diagleft"],       self.screen, (108, 12), False),
				(tiles["diagleft"],       self.screen, (109, 11), False),
				(tiles["diagleft"],       self.screen, (110, 10), False),
				(tiles["diagleft"],       self.screen, (112, 8), False),
				(tiles["diagleft"],       self.screen, (113, 7), False),
				(tiles["diagleft"],       self.screen, (114, 6), False),
				(tiles["diagleft"],       self.screen, (116, 4), False),
				(tiles["turnleftleft"],   self.screen, (117, 3), False),

				(tiles["horiznc"],        self.screen, (116, 5), False),
				(tiles["horiz"],          self.screen, (117, 5), False),

				(tiles["horiznc"],        self.screen, (112, 9), False),
				(tiles["horiz"],          self.screen, (113, 9), False),
				(tiles["diagleft"],       self.screen, (115, 8), False),
				(tiles["turnleftleft"],   self.screen, (116, 7), False),
				(tiles["horiz"],          self.screen, (117, 7), False),

				(tiles["horiz"],          self.screen, (115, 9), False),
				(tiles["horiznc"],        self.screen, (116, 9), False),
				(tiles["horiz"],          self.screen, (117, 9), False),

				(tiles["horiznc"],        self.screen, (108, 13), False),
				(tiles["horiz"],          self.screen, (109, 13), False),

				(tiles["diagleft"],       self.screen, (111, 12), False),
				(tiles["turnleftleft"],   self.screen, (112, 11), False),
				(tiles["horiz"],          self.screen, (113, 11), False),
				(tiles["horiznc"],        self.screen, (114, 11), False),
				(tiles["horiz"],          self.screen, (115, 11), False),
				(tiles["horiznc"],        self.screen, (116, 11), False),
				(tiles["horiz"],          self.screen, (117, 11), False),

				(tiles["horiz"],          self.screen, (111, 13), False),
				(tiles["horiznc"],        self.screen, (112, 13), False),
				(tiles["horiznc"],        self.screen, (114, 13), False),
				(tiles["horiz"],          self.screen, (115, 13), False),
				(tiles["horiznc"],        self.screen, (116, 13), False),
				(tiles["horiz"],          self.screen, (117, 13), False),

				(tiles["diagright"],      self.screen, (114, 14), False),
				(tiles["horiznc"],        self.screen, (116, 15), False),
				(tiles["horiz"],          self.screen, (117, 15), False),
				(tiles["diagright"],      self.screen, (116, 16), False),

				(tiles["horiznc"],        self.screen, (118, 17), False),
				(tiles["horiz"],          self.screen, (119, 17), False),
				(tiles["horiz"],          self.screen, (121, 17), False),
				(tiles["horiznc"],        self.screen, (122, 17), False),
				(tiles["horiz"],          self.screen, (123, 17), False),

				(tiles["diagright"],      self.screen, (121, 18), False),
				(tiles["turnrightleft"],  self.screen, (122, 19), False),
				(tiles["horiz"],          self.screen, (123, 19), False),

				(tiles["diagright"],      self.screen, (118, 18), False),
				(tiles["diagright"],      self.screen, (119, 19), False),
				(tiles["diagright"],      self.screen, (120, 20), False),

				(tiles["horiznc"],        self.screen, (122, 21), False),
				(tiles["horiz"],          self.screen, (123, 21), False),
	...
	def DefineButtons(self, tiles):
		...
		for btnnm, btnpos in btnList:
			self.buttons[btnnm] = Button(self, self.screen, self.frame, btnnm, btnpos, tiles)
	...
	def DefineSignals(self, tiles):
		...
		self.routes["CRtC11G21"] = Route(self.screen, block, "CRtC11G21", "C11", [ (119, 30), (120, 30), (121, 29), (122, 28), (123, 28), (124, 28), (125, 28) ], "G21", [RESTRICTING, RESTRICTING], ["CSw41"], ["C4R", "C4LD"])
		self.routes["CRtC11C10"] = Route(self.screen, block, "CRtC11C10", "C11", [ (119, 30), (120, 30), (121, 30), (122, 30), (123, 30), (124, 30), (125, 30) ], "C10", [MAIN, MAIN], ["CSw39", "CSw41"], ["C4R", "C4LC"])
		self.routes["CRtC11C30"] = Route(self.screen, block, "CRtC11C30", "C11", [ (119, 30), (120, 30), (121, 30), (122, 31), (123, 32), (124, 32), (125, 32) ], "C30", [SLOW, SLOW], ["CSw37", "CSw39", "CSw41"], ["C4R", "C4LB"])
		self.routes["CRtC11C31"] = Route(self.screen, block, "CRtC11C31", "C11", [ (119, 30), (120, 30), (121, 30), (122, 31), (123, 32), (124, 33), (125, 34) ], "C31", [RESTRICTING, SLOW], ["CSw37", "CSw39", "CSw41"], ["C4R", "C4LA"])
		...
		self.routes["CRtG12C20"] = Route(self.screen, block, "CRtG12C20", "G12", [ (146, 26), (147, 27), (148, 28), (149, 29), (150, 30), (151, 30) ], "C20", [RESTRICTING, RESTRICTING], ["CSw31", "CSw35"], ["C2RD", "C2L"])
		self.routes["CRtG10C20"] = Route(self.screen, block, "CRtG10C20", "G10", [ (146, 28), (147, 28), (148, 28), (149, 29), (150, 30), (151, 30) ], "C20", [RESTRICTING, RESTRICTING], ["CSw31", "CSw35"], ["C2RC", "C2L"])
		self.routes["CRtC10C20"] = Route(self.screen, block, "CRtC10C20", "C10", [ (146, 30), (147, 30), (148, 30), (149, 30), (150, 30), (151, 30) ], "C20", [SLOW, SLOW], ["CSw31", "CSw33"], ["C2RB", "C2L"])
		self.routes["CRtC30C20"] = Route(self.screen, block, "CRtC30C20", "C30", [ (146, 32), (147, 32), (148, 31), (149, 30), (150, 30), (151, 30) ], "C20", [SLOW, SLOW], ["CSw31", "CSw33"], ["C2RA", "C2L"])
		...
		self.routes["CRtC20C44"] = Route(self.screen, block, "CRtC20C44", "C20", [ (144, 3), (145, 3), (146, 3), (147, 3), (148, 3), (149, 3), (150, 3), (151, 3), (152, 3), (153, 3), (154, 3)  ], "C44", [SLOW, SLOW], ["CSw43", "CSw49"], ["C6RF", "C6L"])
		self.routes["CRtC20C43"] = Route(self.screen, block, "CRtC20C43", "C20", [ (144, 5), (145, 5), (146, 5), (147, 5), (148, 5), (149, 4), (150, 3), (151, 3), (152, 3), (153, 3), (154, 3)  ], "C43", [SLOW, SLOW], ["CSw43", "CSw49"], ["C6RE", "C6L"])
		self.routes["CRtC20C42"] = Route(self.screen, block, "CRtC20C42", "C20", [ (144, 7), (145, 7), (146, 7), (147, 7), (148, 7), (149, 7), (150, 6), (151, 5), (152, 4), (153, 3), (154, 3)  ], "C42", [SLOW, SLOW], ["CSw43", "CSw45", "CSw51"], ["C6RD", "C6L"])
		self.routes["CRtC20C41"] = Route(self.screen, block, "CRtC20C41", "C20", [ (144, 9), (145, 8), (146, 7), (147, 7), (148, 7), (149, 7), (150, 6), (151, 5), (152, 4), (153, 3), (154, 3)  ], "C41", [SLOW, SLOW], ["CSw43", "CSw45", "CSw51"], ["C6RC", "C6L"])
		self.routes["CRtC20C40"] = Route(self.screen, block, "CRtC20C40", "C20", [ (139, 11), (140, 11), (141, 11), (142, 11), (143, 11), (144, 11), (145, 11), (146, 10), (147, 9), (148, 8), (149, 7), (150, 6), (151, 5), (152, 4), (153, 3), (154, 3)  ], "C40", [SLOW, SLOW], ["CSw43", "CSw45", "CSw47"], ["C6RB", "C6L"])
		self.routes["CRtC20C21"] = Route(self.screen, block, "CRtC20C21", "C20", [ (139, 13), (140, 13), (141, 13), (142, 13), (143, 13), (144, 12), (145, 11), (146, 10), (147, 9), (148, 8), (149, 7), (150, 6), (151, 5), (152, 4), (153, 3), (154, 3)  ], "C21", [MAIN, MAIN], ["CSw43", "CSw45", "CSw47", "CSw63"], ["C6RA", "C6L"])
		self.routes["CRtC20C50"] = Route(self.screen, block, "CRtC20C50", "C20", [ (139, 15), (140, 15), (141, 15), (142, 14), (143, 13), (144, 12), (145, 11), (146, 10), (147, 9), (148, 8), (149, 7), (150, 6), (151, 5), (152, 4), (153, 3), (154, 3)  ], "C50", [SLOW, SLOW], ["CSw43", "CSw45", "CSw47", "CSw63", "CSw65"], ["C6RG", "C6L"])
		self.routes["CRtC20C51"] = Route(self.screen, block, "CRtC20C51", "C20",
				[ (133, 17), (134, 17), (135, 17), (136, 17), (137, 17), (138, 17), (139, 17), (140, 16), (141, 15), (142, 14), (143, 13), (144, 12), (145, 11), (146, 10), (147, 9), (148, 8), (149, 7), (150, 6), (151, 5), (152, 4), (153, 3), (154, 3)  ], "C51", [SLOW, SLOW], ["CSw43", "CSw45", "CSw47", "CSw63", "CSw65", "CSw67", "CSw69"], ["C6RH", "C6L"])
		self.routes["CRtC20C52"] = Route(self.screen, block, "CRtC20C52", "C20",
				[ (133, 19), (134, 19), (135, 18), (136, 17), (137, 17), (138, 17), (139, 17), (140, 16), (141, 15), (142, 14), (143, 13), (144, 12), (145, 11), (146, 10), (147, 9), (148, 8), (149, 7), (150, 6), (151, 5), (152, 4), (153, 3), (154, 3)  ], "C52", [SLOW, SLOW], ["CSw43", "CSw45", "CSw47", "CSw63", "CSw65", "CSw67", "CSw69"], ["C6RJ", "C6L"])
		self.routes["CRtC20C53"] = Route(self.screen, block, "CRtC20C53", "C20",
				[ (133, 21), (134, 21), (135, 21), (136, 20), (137, 19), (138, 18), (139, 17), (140, 16), (141, 15), (142, 14), (143, 13), (144, 12), (145, 11), (146, 10), (147, 9), (148, 8), (149, 7), (150, 6), (151, 5), (152, 4), (153, 3), (154, 3)  ], "C53", [SLOW, SLOW], ["CSw43", "CSw45", "CSw47", "CSw63", "CSw65", "CSw67", "CSw71"], ["C6RK", "C6L"])
		self.routes["CRtC20C54"] = Route(self.screen, block, "CRtC20C54", "C20",
				[ (133, 23), (134, 22), (135, 21), (136, 20), (137, 19), (138, 18), (139, 17), (140, 16), (141, 15), (142, 14), (143, 13), (144, 12), (145, 11), (146, 10), (147, 9), (148, 8), (149, 7), (150, 6), (151, 5), (152, 4), (153, 3), (154, 3)  ], "C54", [SLOW, SLOW], ["CSw43", "CSw45", "CSw47", "CSw63", "CSw65", "CSw67", "CSw71"], ["C6RL", "C6L"])
		...
		self.routes["CRtC44C22"] = Route(self.screen, block, "CRtC44C22", "C44", [ (106, 13), (107, 13), (108, 12), (109, 11), (110, 10), (111, 9), (112, 8), (113, 7), (114, 6), (115, 5), (116, 4), (117, 3)  ], "C22", [SLOW, SLOW], ["CSw57", "CSw59", "CSw61"], ["C8R", "C8LF"])
		self.routes["CRtC43C22"] = Route(self.screen, block, "CRtC43C22", "C43", [ (106, 13), (107, 13), (108, 12), (109, 11), (110, 10), (111, 9), (112, 8), (113, 7), (114, 6), (115, 5), (116, 5), (117, 5)  ], "C22", [SLOW, SLOW], ["CSw57", "CSw59", "CSw61"], ["C8R", "C8LE"])
		self.routes["CRtC42C22"] = Route(self.screen, block, "CRtC42C22", "C42", [ (106, 13), (107, 13), (108, 12), (109, 11), (110, 10), (111, 9), (112, 9), (113, 9), (114, 9), (115, 8), (116, 7), (117, 7)  ], "C22", [SLOW, SLOW], ["CSw53", "CSw59", "CSw61"], ["C8R", "C8LD"])
		self.routes["CRtC41C22"] = Route(self.screen, block, "CRtC41C22", "C41", [ (106, 13), (107, 13), (108, 12), (109, 11), (110, 10), (111, 9), (112, 9), (113, 9), (114, 9), (115, 9), (116, 9), (117, 9)  ], "C22", [SLOW, SLOW], ["CSw53", "CSw59", "CSw61"], ["C8R", "C8LC"])
		self.routes["CRtC40C22"] = Route(self.screen, block, "CRtC40C22", "C40", [ (106, 13), (107, 13), (108, 13), (109, 13), (110, 13), (111, 12), (112, 11), (113, 11), (114, 11), (115, 11), (116, 11), (117, 11)  ], "C22", [SLOW, SLOW], ["CSw55", "CSw61"], ["C8R", "C8LB"])
		self.routes["CRtC21C22"] = Route(self.screen, block, "CRtC21C22", "C21", [ (106, 13), (107, 13), (108, 13), (109, 13), (110, 13), (111, 13), (112, 13), (113, 13), (114, 13), (115, 13), (116, 13), (117, 13)  ], "C22", [MAIN, DIVERGING], ["CSw55", "CSw61", "CSw73"], ["C8R", "C8LA"])
		self.routes["CRtC50C22"] = Route(self.screen, block, "CRtC50C22", "C50", [ (106, 13), (107, 13), (108, 13), (109, 13), (110, 13), (111, 13), (112, 13), (113, 13), (114, 14), (115, 15), (116, 15), (117, 15)  ], "C22", [SLOW, SLOW], ["CSw55", "CSw61", "CSw73", "CSw75"], ["C8R", "C8LG"])
		self.routes["CRtC51C22"] = Route(self.screen, block, "CRtC51C22", "C51", [
				(106, 13), (107, 13), (108, 13), (109, 13), (110, 13), (111, 13), (112, 13), (113, 13), (114, 14), (115, 15), (116, 16), (117, 17), (118, 17), (119, 17), (120, 17), (121, 17), (122, 17), (123, 17)  ], "C22", [SLOW, SLOW], ["CSw55", "CSw61", "CSw73", "CSw75", "CSw77", "CSw79"], ["C8R", "C8LH"])
		self.routes["CRtC52C22"] = Route(self.screen, block, "CRtC52C22", "C52", [
				(106, 13), (107, 13), (108, 13), (109, 13), (110, 13), (111, 13), (112, 13), (113, 13), (114, 14), (115, 15), (116, 16), (117, 17), (118, 17), (119, 17), (120, 17), (121, 18), (122, 19), (123, 19)  ], "C22", [SLOW, SLOW], ["CSw55", "CSw61", "CSw73", "CSw75", "CSw77", "CSw79"], ["C8R", "C8LJ"])
		self.routes["CRtC53C22"] = Route(self.screen, block, "CRtC53C22", "C53", [
				(106, 13), (107, 13), (108, 13), (109, 13), (110, 13), (111, 13), (112, 13), (113, 13), (114, 14), (115, 15), (116, 16), (117, 17), (118, 18), (119, 19), (120, 20), (121, 21), (122, 21), (123, 21)  ], "C22", [SLOW, SLOW], ["CSw55", "CSw61", "CSw73", "CSw75", "CSw77", "CSw81"], ["C8R", "C8LK"])
		self.routes["CRtC54C22"] = Route(self.screen, block, "CRtC54C22", "C54", [
				(106, 13), (107, 13), (108, 13), (109, 13), (110, 13), (111, 13), (112, 13), (113, 13), (114, 14), (115, 15), (116, 16), (117, 17), (118, 18), (119, 19), (120, 20), (121, 21), (122, 22), (123, 23)  ], "C22", [SLOW, SLOW], ["CSw55", "CSw61", "CSw73", "CSw75", "CSw77", "CSw81"], ["C8R", "C8LL"])
