...
class Dell (District):
	...
	def DefineSignals(self, tiles):
		...
		self.routes["DRtH13D11"] = Route(self.screen, block, "DRtH13D11", "D11", [ (46,  9), (47,  9), (48, 10), (49, 11), (50, 11), (51, 11), (52, 11), (53, 11), (54, 11), (55, 11) ], "H13", [RESTRICTING, DIVERGING], ["DSw1:R", "DSw5:N", "DSw7:N"], ["D6RA", "D6L"])
		self.routes["DRtD10D11"] = Route(self.screen, block, "DRtD10D11", "D11", [ (46, 11), (47, 11), (48, 11), (49, 11), (50, 11), (51, 11), (52, 11), (53, 11), (54, 11), (55, 11) ], "D10", [RESTRICTING, MAIN],      ["DSw1:N", "DSw5:N", "DSw7:N"], ["D6RB", "D6L"])
		self.routes["DRtD20D11"] = Route(self.screen, block, "DRtD20D11", "D11", [ (46, 13), (47, 13), (48, 13), (49, 13), (50, 12), (51, 11), (52, 11), (53, 11), (54, 11), (55, 11) ], "D20", [DIVERGING, RESTRICTING], ["DSw3:N", "DSw5:R", "DSw7:N"], ["D4RA", "D6L"])
		self.routes["DRtH23D11"] = Route(self.screen, block, "DRtH23D11", "D11", [ (46, 15), (47, 15), (48, 14), (49, 13), (50, 12), (51, 11), (52, 11), (53, 11), (54, 11), (55, 11) ], "H23", [DIVERGING, RESTRICTING], ["DSw3:R", "DSw5:R", "DSw7:N"], ["D4RB", "D6L"])
		...
		self.routes["DRtD11S10"] = Route(self.screen, block, "DRtD11S10", "S10", [ (66, 11), (67, 11), (68, 11), (69, 11), (70, 11) ], "D11", [MAIN, MAIN],             ["DSw11:N"], ["D12R", "D12R"])
		self.routes["DRtD21S10"] = Route(self.screen, block, "DRtD21S10", "S10", [ (66, 13), (67, 13), (68, 12), (69, 11), (70, 11) ], "D21", [DIVERGING, DIVERGING],   ["DSw11:R"], ["D10R", "D12L"])
