	...
	def DefineBlocks(self, tiles):
		...
		self.blocks["C11"] = Block(self, self.frame, "C11",
			[
				...
				(tiles["verticalnc"],self.screen,    (114, 19), False),
				(tiles["vertical"], self.screen,     (114, 20), False),
				(tiles["verticalnc"],self.screen,    (114, 21), False),
				(tiles["vertical"], self.screen,     (114, 22), False),
				(tiles["verticalnc"],self.screen,    (114, 23), False),
				(tiles["vertical"], self.screen,     (114, 24), False),
				(tiles["verticalnc"],self.screen,    (114, 25), False),
				(tiles["vertical"], self.screen,     (114, 26), False),
